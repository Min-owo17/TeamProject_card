    ...
    <div class="row">
      <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
        ...
        <div class="block about">
          <!-- footer logo -->
          <img src="images/cardmainlogo.png" alt="">
          <!-- description -->
          <p class="alt-color">1조 팀장 - 김민혜 팀원 - 윤영재, 성국정, 박상욱, 홍혜민</p>
        </div>
      </div>
      <!-- Link list -->
...
<footer class="footer-bottom">
  ...
  <script src="${pageContext.request.contextPath}/https://maps.googleapis.com/maps/api/js?key=AIzaSyCC72vZw-6tGqFyRhhg5CkF2fqfILn2Tsw"></script>
